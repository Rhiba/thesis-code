...
##  Extend on: Aug 24, 2020 by Rhiannon Michelmore
##
...
class HitmanCost(object):
    ...
    def __init__(self, bootstrap_with=[], costs=[], solver='g3', htype='sorted'):
        """
            Constructor.
        """
    ...
    def hit(self, to_hit):
        ...
        for vid in new_obj:
            cost = costs[vid-1]
            self.oracle.add_clause([-vid], weight=cost)
