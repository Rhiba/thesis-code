...
class World(object):
	def __init__(self, carla_world, hud, model):
		...
		self.camera_manager = CameraManager(self.vehicle, self.hud, self.model)
		self.camera_manager.set_sensor(0, notify=False)
		self.controller = None
		self._weather_presets = find_weather_presets()
		#self._weather_index = 4 # this will set weather to 5
		#self.next_weather() # bc weather is incremented here
		self._weather_index = 0 # this will set weather to 5
...
class CameraManager(object):
	def __init__(self, parent_actor, hud, model):
		self.model = model
		self.sensor = None
		self._surface = None
		self._parent = parent_actor
...
def game_loop(args):
	...
	try:
		...
		world = World(client.get_world(), hud, model)
