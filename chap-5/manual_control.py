...
class World(object):
	def __init__(self, carla_world, hud):
		...
		print(spawn_point)
		#!*!
		#spawn_point.location.x = 4.8923 # 7.6
		#spawn_point.location.y = 52.2067 # -48.5
		#spawn_point.rotation.yaw = -87.0 # -86
		spawn_point.location.x = 19.6
		spawn_point.location.y = -134.3
		spawn_point.rotation.yaw = 1
		#spawn_point.location.x = -44.4
		#spawn_point.location.y = 0.9
		#spawn_point.rotation.yaw = -1.0
